...
public class ClienteSocketSwing extends JFrame {
	...
	private final JTextArea taEditor = new JTextArea("digite aqui sua mensagem");
	private final JTextArea taVisor = new JTextArea();
	private final JList liUsarios = new JList();
	private PrintWriter escritor;
	private BufferedReader leitor;
	private final JScrollPane scrollTaVisor = new JScrollPane(taVisor);

	public ClienteSocketSwing() {
		
		setTitle("Chat com sockets - LOP2");
...
//		taVisor.setPreferredSize(new Dimension(350, 100));
		...
		String[] usuarios = new String[]{"carlos", "lincoln", "ederson", "eduardo", "renata", "marizete", "mateus", "robson"};
		...
		try {
			while(true){
				...
				if(mensagem.equals(Comandos.LISTA_USUARIOS)){
					...
					JOptionPane.showMessageDialog(ClienteSocketSwing.this, "o login inválido");
